...
// console.log(getStringLength('Nabucodonosor'))
...
// console.log(getIndex('E','CHOCOTONE'))
...
const videos = ['Rodma Panina', 'Quero café', 'No céu tem pão']
const isItemIncluded = (item, array) => array.includes(item)

// console.log(isItemIncluded('Anything', videos))
...
*/
const videos2 = ['Cacete de agulha', 'Dog interessante', 'Vamo q vamo']

const concatArrays = (firstArray, secondArray) => firstArray.concat(secondArray)

// console.log(concatArrays(videos, videos2))
...
// const logName = () => console.log('Rodrigo')
...
// console.log(invokeCallback(33,triple))
...
const names = ['Rafael', 'Ana Paula', 'Victor', 'Alessandro']
